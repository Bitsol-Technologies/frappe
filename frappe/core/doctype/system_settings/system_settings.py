...
class SystemSettings(Document):
	...
	if TYPE_CHECKING:
		...
		clockify_api_key: DF.Data | None
		clockify_workspace_id: DF.SmallText | None
		...
		slack_api_url: DF.Data | None
		slack_post_message_url: DF.Data | None
		slack_token: DF.Data | None
